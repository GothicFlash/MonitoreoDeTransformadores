...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            @include('config-user.partials.header')
            @include('config-user.partials.sidebar')
        </nav>
        <div id="page-wrapper">
          <div class="row">
              <div class="col-lg-12">
    ...
    <!-- Functions to redirect to specific view using Ajax -->
    <script src="{!! asset('views/redirectToUrl.js') !!}"></script>
    @include('sweet::alert')
    @yield('script')
</body>
</html>
